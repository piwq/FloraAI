  ...
  return (
    ...
    >
      <div className="flex-grow flex flex-col overflow-y-auto overflow-x-hidden">
        <button
          onClick={onNewChat}
          className="flex items-center justify-center w-full bg-accent-ai text-white font-bold py-3 px-4 rounded-lg
                           hover:opacity-90 transition-opacity mb-6 flex-shrink-0">
          <Plus size={20} className="mr-2" /> Новый чат
        </button>

        <div className="flex-grow overflow-y-auto pr-2 -mr-2">
          <h3 className="text-sm text-text-secondary font-semibold mb-2 px-2">Недавние сны</h3>
            ...
            <ul className="space-y-1">
                <li>
                    <Link to="/about" className="flex items-center px-4 py-2.5 rounded-lg text-sm text-text-secondary hover:bg-surface-1">
                        <Info size={16} className="mr-3" /> О нас
                    </Link>
                </li>
                <li>
                ...
                <li>
                    <a href="https://t.me/DreamMorpheusBot" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2.5 rounded-lg text-sm text-text-secondary hover:bg-surface-1">
                        <Send size={16} className="mr-3" /> Бот в Telegram
                    </a>
                </li>
            </ul>
        </div>
      ...
      <div className="pt-4 mt-2 border-t border-border-color flex-shrink-0">
        <Link to="/profile" className="flex items-center justify-between p-2 rounded-lg hover:bg-surface-1 transition-colors group">
          <div className="flex items-center overflow-hidden">
            <div className="w-8 h-8 rounded-full bg-gradient-user flex-shrink-0 flex items-center justify-center mr-3">
